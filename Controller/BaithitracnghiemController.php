    ...
    class BaithitracnghiemController{
        ...
        public function create() {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($this->baithitracnghiemModel->create($ten_baithi, $mota_baithi, $ngaytaobaithi,$isDeleted, $time, $heso)) {
        ...
        public function update() {
            if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST["id_baithi"]) && !empty($_POST["ten_baithi"])&& !empty($_POST["mota_baithi"])) {
                ...
                if ($this->baithitracnghiemModel->update($id_baithi, $ten_baithi,$mota_baithi,$ngaysuabaithi, $isDeleted, $time, $heso)) {
                    header("Location: index.php?controller=Baithitracnghiem&action=index");
                    exit();
                }
            }
