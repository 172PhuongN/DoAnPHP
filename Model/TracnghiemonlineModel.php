...
Class TracnghiemOnlineModel{
    ...
    public function getBaiThiById($id_baithi) {
        $stmt = $this->conn->prepare("SELECT * FROM baithitracnghiem WHERE id_baithi = :id_baithi");
        $stmt->bindParam(':id_baithi', $id_baithi);
        $stmt->execute();
    ...
    public function saveBaiLam($id_nguoidung, $id_baithi, $answers, $thoigian_batdau,$id_monhoc) {
        try {
            ...
            $stmt = $this->conn->prepare("INSERT INTO baithi_user (userName, id_baithi, thoigianlambai,id_monhoc) VALUES (?, ?, ?,?)");
            $stmt->execute([$id_nguoidung, $id_baithi, $thoigian_lambai, $id_monhoc]);
    ...
    public function kiemTraDaLamBai($id_nguoidung, $id_baithi, $id_monhoc) {
        $query = "
            SELECT COUNT(*) 
            FROM baithi_user 
            WHERE userName = ? 
        ...
        ";
        $stmt = $this->conn->prepare($query);
        $stmt->execute([$id_nguoidung, $id_baithi, $id_monhoc]);
