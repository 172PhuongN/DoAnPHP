    ...
    <div class="card shadow-lg p-4 rounded-4">
        <form method="post" action="?controller=Baithitracnghiem&action=update">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="time" class="form-control" value="<?php echo htmlspecialchars($baithi->time); ?>" required>
            </div> 
            <div class="mb-3">
                <label class="form-label fw-semibold">heso:</label>
                <input type="text" name="heso" class="form-control" value="<?php echo htmlspecialchars($baithi->heso); ?>" required>
            </div>
            <div class="mb-3">
