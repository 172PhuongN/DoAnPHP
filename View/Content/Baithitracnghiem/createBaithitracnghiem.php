...
<h1 class="text-center text-gradient mt-4 fw-bold">✏️ Create Bai thi trac nghiem </h1>
    ...
    <div class="card shadow-lg p-4 rounded-4">
        <form action="index.php?controller=baithitracnghiem&action=create" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="time" name="time"></textarea>
            </div>
            <div class="mb-3">
                <label for="heso" class="form-label">Hệ Số</label>
                <textarea class="form-control" id="heso" name="heso"></textarea>
            </div>
